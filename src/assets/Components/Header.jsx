      ...
      <div className="flex justify-evenly container mx-auto">
        <div className=" flex flex-col items-center justify-center">
          ...
          <div className="gap-5 flex justify-center items-center pt-5">
            <button>
              ...
              <FontAwesomeIcon icon={faGithub} className="text-4xl hover:text-gray-700" />
              </a>
            </button>
            <button>
              <a href="https://www.linkedin.com/in/ashish-adhikari-92364217a/" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faLinkedin} className="text-4xl hover:text-gray-700" />
              </a>
            </button>
          </div>
        </div>
        <div>
          <img
            src={profileImg}
            alt=""
            className="h-50 rounded-full w-full max-w-lg"
          />
        </div>
      </div>
    </div>
