...
const Navbar = () => {
  return (
    <div className="flex justify-evenly container py-5 px-20 mx-auto shadow-md gap-20 fixed z-50">
      ...
      <ul className="flex gap-8 px-5 py-3 font-bold">
        ...
        <a className="hover:text-blue-500 transition-all" href="#Projects">SKILLS</a>
        <a className="hover:text-blue-500 transition-all" href="#Experience">PROJECTS</a>
